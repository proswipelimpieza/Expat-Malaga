...
affiliateLinks:
  - name: "Wise"
    ...
    commission: "Paiements internationaux, facturation multi-devises pour autonomos"
    description: "Compte pro Wise gratuit pour facturer des clients français en euros sans frais. Parfait pour les autonomos qui gardent des clients en France."
---
...
Séparez vie perso et pro. Les banques espagnoles proposent des **cuentas autónomos** gratuites sous conditions (Openbank, BBVA autonomos, ING Business). Sinon, compte Wise business avec IBAN ES.

<AffiliateCard
  name="Wise"
  url="https://wise.com/invite/u/"
  description="Compte Business Wise gratuit, IBAN ES + FR + 10 autres pays, taux de change réel. Idéal pour facturer en euros des clients français ou belges et recevoir sans frais. Export facile des relevés pour votre gestoría."
  cta="Ouvrir un compte Business"
  tag="Facturation autonomo"
/>
...
**Logiciels recommandés** : Quipu, Holded, Contasimple. Comptez 10-25 €/mois. Très français et aussi utilisés : Qonto (bancaire uniquement), Wise (pas de devis/factures).
...
4. Ouvrez un compte pro (Wise ou BBVA Autonomos).
