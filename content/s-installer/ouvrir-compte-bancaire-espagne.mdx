...
affiliateLinks:
  - name: "N26"
    ...
    commission: "IBAN espagnol, interface française, ouverture 100% en ligne"
    description: "Banque 100% mobile avec IBAN ES, interface en français et frais réduits."
  - name: "Wise"
    url: "https://wise.com/invite/u/"
    commission: "Compte multi-devises avec IBAN espagnol, transfert au taux réel"
    description: "Le plus pratique pour conserver un pied en euros France + euros Espagne et transférer sans frais cachés."
  - name: "Revolut"
    url: "https://revolut.com/referral/"
    commission: "IBAN lituanien accepté en Espagne, change gratuit en semaine"
    description: "Pratique pour dépenser dans plusieurs devises, mais moins bien accepté que N26 par les bailleurs espagnols."
---
...
<AffiliateCard
  name="N26"
  url="https://n26.com/fr-es/r/"
  description="Ouverture en 8 minutes depuis le téléphone, carte Mastercard virtuelle immédiate, interface en français et IBAN ES. Le meilleur compromis pour un expat français qui veut un compte espagnol sans passer par une agence."
  cta="Ouvrir un N26"
  tag="Banque en ligne"
/>
...
<AffiliateCard
  name="Wise"
  url="https://wise.com/invite/u/"
  description="IBAN espagnol + IBAN français + 40 autres devises sur un seul compte, taux de change réel. Parfait pour les expats qui gardent des revenus ou des dépenses en France (salaire, CAF, loyer parisien à payer, etc.)."
  cta="Créer un compte Wise"
  tag="Multi-devises"
/>
